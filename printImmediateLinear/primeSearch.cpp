...
private:
  ...
  void printThread(unsigned long long number) {
    ...
    // std::cout << "(" << buffer << ") " << "Thread " << std::this_thread::get_id() << " found prime: " << number << std::endl;
    ...
    std::cout << "(" << ss.str() << ") " << "Thread " << std::this_thread::get_id() << " found prime: " << number << std::endl;
  }
